...
<div class="container px-5 my-5">
    <form method="POST">
        ...
        <div class="mb-3">
            ...
            <select class="form-select" name="mataKuliah" aria-label="mataKuliah">
                <option value="Pemograman web 2">Pemograman web 1</option>
                <option value="Pemograman web 2">Pemograman web 2</option>
                <option value="Pemograman web 2">Basis Data</option>
                <option value="Pemograman web 2">Jaringan Komputer</option>
